...
OUTPUT = ROOT / "output" / "pdf" / "dyness-balancer-algorithm-reference.pdf"
...
def build() -> Path:
    ...
    story += [
        ...
        p("1 Architecture and authority  |  2 RS485 telemetry  |  3 Controller state machine  |  4 Current control  |  5 Virtual BMS and DVCC  |  6 Operator operations  |  7 CSV recording format  |  8 Troubleshooting", "body"),
        PageBreak(),
    ]
